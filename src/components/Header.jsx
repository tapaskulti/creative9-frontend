              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  <div className="card-body">
                    <span className="text-lg font-bold">{cartTotalQuantity} Items</span>
                    <span className="text-info">Subtotal: INR {cartTotalAmount}</span>
                    <div className="card-actions">
                      <button onClick={handlePay}  className="btn btn-primary btn-block">
                        View cart
                      </button>
                    </div>
                  </div>
                ...
                <div className="">
                  ...
                  {adminView && (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        isActive
                          ? "px-3 py-1 text-orange-600 font-semibold"
                          : ""
                      }
                    >
                      <div className="px-3 py-1">
