...
const ContactUs = () => {
  ...
  return (
    <div className="">
      <Header />
      <div className="">
        <div className="bg-gradient-to-r from-[#297cc0] via-[#0363af] to-[#297cc0] h-32 py-10 text-center text-white text-xl lg:text-4xl">
          Get in Touch!
        </div>
        <div className="mt-5 lg:mt-32 font-sans mb-10 lg:mb-60">
          {/* <h2 className="pb-10 text-4xl text-center uppercase text-slate-900">
            Get in Touch
          </h2> */}
          <div className="flex justify-between px-6 lg:px-32 xl:px-40 2xl:px-64 py-3">
            <div className="w-full lg:w-1/2">
              ...
              <div className="mt-5 lg:mt-10">
                ...
                <h2 className="text-sm font-normal leading-7">
                  Near Netaji Subhas Chandra Bose International Airport, <br />
                  kolkata-700158
                </h2>
              </div>
            </div>
